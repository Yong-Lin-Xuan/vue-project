...
<div class="container">
  <div class="features">
    ...
    [post.id%2 == 0 ? '':' reverse']" v-for="(post, index) in posts" :key="index" :data-index="index">
      <div :class=" 'featured-image-container ipsGrid_span5 gs_reveal' + [post.id%2 == 0 ? ' gs_reveal_fromLeft' : ' gs_reveal_fromRight']">
        <div class="card">
  ...
  data() {
		return {
          ...
          id: 1,
					title: "人類影響自然的規模",
					body:
						"雖然現在人類在全球生物質能只佔0.5%，人類對自然的影響卻相對來說要大得多。因為人為影響規模之大，除非在極端情況下，自然與人工環境的界線均變得含糊。",
          img: "/images/521-1200x800.jpg"
        },
				{
					id: 2,
					title: "人類影響自然的各種活動",
					body:
						"人類利用自然作休閒和經濟活動。取得天然資源作工業用途，是世界經濟系統的一個主要部分。部分活動會被作為生計及休閒目的，例如打獵和捕魚等。農業在前9千年開始發展。",
          img: "/images/523-1200x800.jpg"
				},
				{
					id: 3,
					title: "物種間的連繫",
