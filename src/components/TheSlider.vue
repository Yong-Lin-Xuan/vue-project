      ...
      <div class="carousel-inner">
        <div class="carousel-item active" data-bs-interval="3000">
          ...
          <div class="carousel-caption d-md-block">
            <div class="banner-txt">
              ...
              <h2>不斷運行演化的宇宙萬物</h2>
              <p>
                在地球上最初的生物是微生物，而她們維持著地球唯一的生物形態的地位直到十億年前多細胞生物的出現才告終結。
              </p>
              <button class="btn btn-primary btn-lg ms-auto mb-2 mb-lg-0 me-2" type="button">
                訂閱
              </button>
            </div>
          </div>
        ...
        <div class="carousel-item">
          ...
          <div class="carousel-caption d-md-block">
            <h5>地區區系</h5>
            <p>
              在眾多植物分類方法中，地區區系依研究目的的不同可以包括在上一個紀元的植物殘餘物形成的化石植物。
            </p>
          </div>
        </div>
      </div>
